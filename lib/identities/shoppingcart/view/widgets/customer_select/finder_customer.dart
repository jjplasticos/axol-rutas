...
class FinderCustomer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextfieldModel currentFinder =
        context.read<FinderCustomerCubit>().state;
        ...
        child: Row(
          ...
          children: [
            Expanded(
              child: Padding(
                ...
                child: TextField(
                  ...
                  obscureText: false,
                  onChanged: (value) {
                    context.read<FinderCustomerCubit>().change(TextfieldModel(
                        text: value,
            ...
            IconButton(
              ...
              onPressed: () {
                context
                    .read<FinderCustomerCubit>()
                    .change(const TextfieldModel(text: '', position: 0));
